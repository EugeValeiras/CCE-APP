...
abstract final class CceGradients {
  ...
  /// HueBadge), para que borde y badge sean el mismo arcoíris y no dos
  /// interpretaciones parecidas. De izquierda a derecha, igual que el logo.
  /// ÚNICA fuente del arcoíris — lo consumen HueRoomCard y los chips de
  /// escenas Hue del editor de automatizaciones.
