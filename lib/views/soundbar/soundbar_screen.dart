    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: AnimatedBuilder(
          animation: service,
          // Centrado a ancho de celular (≈320 como el dashboard): en iPad el
          // control NO ocupa todo el ancho (queda feo); en teléfono la pantalla
          // es más angosta así que igual se ve full.
